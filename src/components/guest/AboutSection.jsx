        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-6 left-6 bg-white p-6 rounded-3xl shadow-xl">
              ...
              <p className="text-gray-500">Tahun Melayani Pasien</p>
            </div>
          </div>
          ...
          <div>
            ...
            <h2 className="text-5xl font-bold text-slate-900 mt-6 leading-tight">
              ...
              <span className="text-blue-600"> Senyum Yang Lebih Sehat</span>
            </h2>

            <p className="text-gray-500 mt-6 leading-relaxed text-lg">
              SIGIGI Dental Clinic hadir sebagai solusi kesehatan gigi modern
              dengan menggabungkan teknologi terkini, pelayanan profesional, dan
              sistem CRM yang membantu menjaga hubungan jangka panjang dengan
              pasien.
            </p>

            <p className="text-gray-500 mt-4 leading-relaxed text-lg">
              Kami percaya bahwa setiap senyum memiliki nilai yang berharga.
              Karena itu, kami selalu berkomitmen memberikan pelayanan terbaik
            ...
            <div className="grid md:grid-cols-2 gap-5 mt-10">
              <div className="bg-white rounded-3xl p-6 shadow-sm">
                <h3 className="font-bold text-xl text-slate-900">Visi</h3>

                <p className="text-gray-500 mt-3">
                  Menjadi klinik gigi modern terpercaya dengan pelayanan terbaik
                  dan teknologi terkini.
                </p>
              </div>

              <div className="bg-white rounded-3xl p-6 shadow-sm">
                <h3 className="font-bold text-xl text-slate-900">Misi</h3>

                <p className="text-gray-500 mt-3">
                  Memberikan layanan kesehatan gigi berkualitas tinggi untuk
                  seluruh pasien.
                </p>
              </div>
            </div>
