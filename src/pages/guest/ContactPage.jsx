      ...
      <section className="bg-gradient-to-r from-blue-700 via-cyan-600 to-blue-500 text-white">
        <div className="max-w-7xl mx-auto px-6 py-24 text-center">
          ...
          <p className="mt-4 text-blue-100 max-w-2xl mx-auto">
            Tim SIGIGI siap membantu kebutuhan kesehatan gigi Anda. Hubungi kami
            kapan saja melalui berbagai kanal komunikasi.
          </p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-3">
              Kami siap melayani konsultasi, booking janji temu, serta informasi
              seputar layanan klinik gigi.
            </p>

            <div className="space-y-5 mt-10">
              <div className="bg-white p-5 rounded-3xl shadow-sm flex gap-4">
                <div className="bg-blue-100 p-3 rounded-2xl h-fit">
                  <MdLocationOn size={28} className="text-blue-600" />
                </div>

                <div>
                  <h3 className="font-bold">Alamat Klinik</h3>
              ...
              <div className="bg-white p-5 rounded-3xl shadow-sm flex gap-4">
                <div className="bg-green-100 p-3 rounded-2xl h-fit">
                  <MdPhone size={28} className="text-green-600" />
                </div>
              ...
              <div className="bg-white p-5 rounded-3xl shadow-sm flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 mt-1">info@sigigi.com</p>
                </div>
              </div>

              <div className="bg-white p-5 rounded-3xl shadow-sm flex gap-4">
                <div className="bg-orange-100 p-3 rounded-2xl h-fit">
                  <MdAccessTime size={28} className="text-orange-600" />
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-500">Sabtu : 08.00 - 17.00</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        <div className="bg-white rounded-3xl overflow-hidden shadow-sm">
          <div className="p-6 border-b">
            <h2 className="text-2xl font-bold">Lokasi Klinik</h2>
          </div>

          <div className="overflow-hidden rounded-b-3xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31914.625100858957!2d100.3326591!3d-0.898141!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd4b9a42e402a6d%3A0x76b85dff658a5a3b!2sDental%20Clinic%20Dluk%E2%80%99s%20%7C%20Dokter%20Gigi%20Padang!5e0!3m2!1sid!2sid!4v1780755000946!5m2!1sid!2sid"
              width="100%"
              height="500"
              style={{ border: 0 }}
              allowFullScreen
